...
import { Factory, Lock, Eye, EyeOff, ArrowRight, ShieldCheck } from 'lucide-react';
                ...
                <motion.header initial={{ opacity: 0, y: -16 }} animate={{ opacity: 1, y: 0 }} className="flex items-center justify-between">
                    <Link to="/" className="inline-flex items-center gap-3 group">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-text-muted font-mono uppercase tracking-widest">Password Update</p>
                        </div>
                    </Link>
                    <ThemeToggle />
                </motion.header>
